...
/*   Updated: 2023/09/27 17:27:15 by jemercie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	this->_ad = amount;
	std::cout << " Now, " << this->_name << " have " << amount << " attack damage points." << std::endl << std::endl;
}
...
unsigned int	ClapTrap::getStats(int i)
{
	if (i == HEALTH)
		return (this->_health);
	if (i == ENERGY)
